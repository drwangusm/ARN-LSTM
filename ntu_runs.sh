...
# python3 src/run_protocol.py ARN_rel_ave_before_lstm configs/NTU-V2/lstm/ARN_rel_ave_before_lstm.cfg NTU-V2 -t -F middle -n 5 -v 2 # x
# python3 src/run_protocol.py ARN_rel_att_before_lstm configs/NTU-V2/lstm/ARN_rel_att_before_lstm.cfg NTU-V2 -t -F middle -n 5 -v 2 # x
# python3 src/run_protocol.py ARN_no_rel_ave_before_lstm configs/NTU-V2/lstm/ARN_no_rel_ave_before_lstm.cfg NTU-V2  -t -F middle -n 5 -v 2 # x
# python3 src/run_protocol.py ARN_no_rel_att_before_lstm configs/NTU-V2/lstm/ARN_no_rel_att_before_lstm.cfg NTU-V2  -t -F middle -n 5 -v 2 # x
...
# NTU-V2 ARN-LSTM fusion inward+outward (需要时间太长，在最后运行)
