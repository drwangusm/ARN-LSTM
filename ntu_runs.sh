...
python3 src/run_protocol.py final_joint_rel_ave_cs configs/no-lstm/NTU-V2/final/final_joint_rel_ave.cfg NTU-V2 -n 5 -f cross_subject
python3 src/run_protocol.py final_joint_rel_ave_cv configs/no-lstm/NTU-V2/final/final_joint_rel_ave.cfg NTU-V2 -n 5 -f cross_view
python3 src/run_protocol.py final_joint_rel_att_cs configs/no-lstm/NTU-V2/final/final_joint_rel_att.cfg NTU-V2 -n 5 -f cross_subject
python3 src/run_protocol.py final_joint_rel_att_cv configs/no-lstm/NTU-V2/final/final_joint_rel_att.cfg NTU-V2 -n 5 -f cross_view
...
python3 src/run_protocol.py final_temp_rel_ave_cs configs/lstm/NTU-V2/final/final_temp_rel_ave.cfg NTU-V2 -n 5 -f cross_subject
python3 src/run_protocol.py final_temp_rel_ave_cv configs/lstm/NTU-V2/final/final_temp_rel_ave.cfg NTU-V2 -n 5 -f cross_view
python3 src/run_protocol.py final_temp_rel_att_cs configs/lstm/NTU-V2/final/final_temp_rel_att.cfg NTU-V2 -n 5 -f cross_subject
python3 src/run_protocol.py final_temp_rel_att_cv configs/lstm/NTU-V2/final/final_temp_rel_att.cfg NTU-V2 -n 5 -f cross_view
