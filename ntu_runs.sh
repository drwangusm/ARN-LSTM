...
python3 src/run_protocol.py final_joint_rel_ave_v1 configs/NTU-V1/no-temp-lstm/final_joint_rel_ave.cfg NTU -n 5 -v 2
python3 src/run_protocol.py final_joint_rel_att_v1 configs/NTU-V1/no-temp-lstm/final_joint_rel_att.cfg NTU -n 5 -v 2

#NTU-V1 temp, lstm no fusion
python3 src/run_protocol.py final_temp_rel_ave_lstm_v1 configs/NTU-V1/temp-lstm/final_temp_rel_ave_lstm.cfg NTU -n 5 -t -v 2
python3 src/run_protocol.py final_temp_rel_att_lstm_v1 configs/NTU-V1/temp-lstm/final_temp_rel_att_lstm.cfg NTU -n 5 -t -v 2
