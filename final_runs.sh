...
python3 src/run_protocol.py RN_joint+temp configs/NTU-V2/no-lstm/RN_joint+temp.cfg NTU-V2 -F middle -n 1 -v 2 # x
...
python3 src/run_protocol.py ARN_inward_no_motion configs/UT/set_2/ARN_inward_no_motion.cfg UT-2 -n 5 -v 2  # x
# ARN_outward compute_distance = false compute_motion = false
python3 src/run_protocol.py ARN_outward_no_motion configs/UT/set_1/ARN_outward_no_motion.cfg UT-1 -n 5 -v 2
python3 src/run_protocol.py ARN_outward_no_motion configs/UT/set_2/ARN_outward_no_motion.cfg UT-2 -n 5 -v 2 # X
# ARN_inward+outward compute_distance = false compute_motion = false
...
#NTU-V1/V2
# ARN_inward compute_distance = false compute_motion = false
python3 src/run_protocol.py ARN_inward_no_motion configs/NTU-V1/ARN_inward_no_motion.cfg NTU -n 1 -v 2 # x
python3 src/run_protocol.py ARN_inward_no_motion configs/NTU-V2/ARN_inward_no_motion.cfg NTU-V2 -n 1 -v 2 # x
# ARN_outward compute_distance = false compute_motion = false
python3 src/run_protocol.py ARN_outward_no_motion configs/NTU-V1/ARN_outward_no_motion.cfg NTU -n 1 -v 2 # x
python3 src/run_protocol.py ARN_outward_no_motion configs/NTU-V2/ARN_outward_no_motion.cfg NTU-V2 -n 1 -v 2 # x
# ARN_inward+outward compute_distance = false compute_motion = false
python3 src/run_protocol.py ARN_inward+outward_no_motion configs/NTU-V1/ARN_inward+outward_no_motion.cfg NTU -F middle -n 1 -v 2 # x
python3 src/run_protocol.py ARN_inward+outward_no_motion configs/NTU-V2/ARN_inward+outward_no_motion.cfg NTU-V2 -F middle -n 1 -v 2 # x

# ARN_inward compute_distance = True compute_motion = True
python3 src/run_protocol.py ARN_inward configs/NTU-V1/ARN_inward.cfg NTU -n 1 -v 2 # x
python3 src/run_protocol.py ARN_inward configs/NTU-V2/ARN_inward.cfg NTU-V2 -n 1 -v 2 # x
# ARN_outward compute_distance = True compute_motion = True
python3 src/run_protocol.py ARN_outward configs/NTU-V1/ARN_outward.cfg NTU -n 1 -v 2 # x
python3 src/run_protocol.py ARN_outward configs/NTU-V2/ARN_outward.cfg NTU-V2 -n 1 -v 2 # x
# ARN_inward+outward compute_distance = True compute_motion = True
python3 src/run_protocol.py ARN_inward+outward configs/NTU-V1/ARN_inward+outward.cfg NTU -F middle -n 1 -v 2 # x
python3 src/run_protocol.py ARN_inward+outward configs/NTU-V2/ARN_inward+outward.cfg NTU-V2 -F middle -n 1 -v 2 # x
python3 src/run_protocol.py ARN-fc1_inward+outward configs/NTU-V1/ARN-fc1_inward+outward.cfg NTU -F middle -n 1 -v 2 # x
python3 src/run_protocol.py ARN-fc1_inward+outward configs/NTU-V2/ARN-fc1_inward+outward.cfg NTU-V2 -F middle -n 1 -v 2 # x
...
python3 src/run_protocol.py ARN-LSTM_inward+outward configs/NTU-V2/ARN-LSTM_inward+outward.cfg NTU-V2 -F middle -n 1 -v 2 # x
python3 src/run_protocol.py ARN-LSTM-fc1_inward+outward configs/NTU-V2/ARN-LSTM-fc1_inward+outward.cfg NTU-V2 -F middle -n 1 -v 2 # x
