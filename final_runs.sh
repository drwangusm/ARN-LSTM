...
python3 src/run_protocol.py ARN_joint+temp configs/NTU-V2/no-lstm/ARN_joint+temp.cfg NTU-V2 -F middle -n 1 -v 2
# ARN-fc1_joint+temp
...
python3 src/run_protocol.py ARN-fc1_inward+outward configs/UT/set_1/ARN-fc1_inward+outward.cfg UT-1 -F middle -n 5 -v 2 # x -
