...
# 定义文件路径
data_paths = {
    "ARN-LSTM_inward fold_0": r"/demo/ARN-LSTM/runs/SBU/ARN-LSTM_inward/fold_0/rerun_0/training.log",
    "ARN-LSTM_inward fold_1": r"/demo/ARN-LSTM/runs/SBU/ARN-LSTM_inward/fold_1/rerun_0/training.log",
    "fold_2": r"/demo/ARN-LSTM/runs/SBU/ARN-LSTM_inward/fold_2/rerun_0/training.log",
    "fold_3": r"/demo/ARN-LSTM/runs/SBU/ARN-LSTM_inward/fold_3/rerun_0/training.log",
    "fold_4":r"/demo/ARN-LSTM/runs/SBU/ARN-LSTM_inward/fold_4/rerun_0/training.log",
}
...
# 调整子图布局
plt.tight_layout()
plt.savefig(r'/demo/ARN-LSTM/plot_figures_results/SBU/ARN-LSTM_inward_all_accuracy.png', dpi=300, bbox_inches='tight')
plt.show()
