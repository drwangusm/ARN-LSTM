...
plt.plot(accuracy_RN_joint_temp, 'bo', label='RN_joint_temd', linestyle='--')
...
# 显示图表
plt.tight_layout()
plt.savefig(r'/demo/ARN-LSTM/plot_figures_results/SBU/RN-all_acc_vs.png',dpi=300,bbox_inches='tight')
plt.show()
