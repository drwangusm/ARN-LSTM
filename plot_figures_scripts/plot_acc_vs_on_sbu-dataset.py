...
plt.ylabel("Accuracy (%)")
plt.title("SBU dataset action recognition performance comparison")
...
# 显示图表
plt.tight_layout()
plt.savefig(r'/demo/ARN-LSTM/plot_figures_results/SBU/RN_acc_vs.png',dpi=300,bbox_inches='tight')
plt.show()
