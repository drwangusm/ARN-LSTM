...
#计算所有fold中每个return（总共50个）的分类识别准确率的平均值


# 定义数据的根目录
root_dir = '/demo/ARN-LSTM/runs/UT-2/ARN-LSTM_inward'
...
# 输出平均值
print("On UT dataset: Average Class Accuracies across all folds and reruns:")
